...
columns = "id,replyto,username,forum,forum_types,discourse,title,when,annotation_language,annotation_link,annotation_rated,annotation_category,annotation_fandom,annotation_relationship,annotation_character,annotation_tags,annotation_status,annotation_comments,annotation_kudos,annotation_bookmarks,annotation_hits,dataset_file,post".split(",")
